...
var hoverzoom = function(){
	...
	var allPic = function(){
		...
		$('div[data-content-type^="image"] img, .ot-anchor, .Sl img, .ru img').each(function(){
			var tag = $(this).prop('tagName');
