...
var timer = new function(){
	...
	var maxPic = function(){
		$('.hotFy').filter(':visible').each(function(){
			if (!$(this).data('class')){
				if ($(this).parent().hasClass('ot-anchor')){
					var src = this.src,
