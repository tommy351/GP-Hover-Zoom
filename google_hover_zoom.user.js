...
function hoverzoom(){
	...
	var locale = options['hz_language'],
		locale_db_1 = 'Download the picture',
		...
		locale_set_13 = 'Not to move pictures with cursor',
	...
	switch (locale)
	{
		...
		case 'ja-JP':
			locale_db_1 = '画像ダウンロード',
			locale_menu_1 = 'Hover Zoom を無効にする',
			locale_menu_2 = 'Hover Zoom を有効にする',
			locale_fs_1 = 'フルスクリーントリガーを押してください、まだはこちらをクリックしてフルスクリーンモードを終了します。',
			locale_fs_2 = '終了',
			locale_fs_3 = 'ダウンロード',
			locale_fs_4 = '読み込み中…',
			locale_fs_6 = 'ページ幅',
			locale_fs_7 = 'オリジナルサイズ (100％)',
			locale_fs_8 = 'フルスクリーン',
			locale_fs_9 = 'ウィンドウサイズ',
			locale_fs_10 = '前の画像',
			locale_fs_11 = '次の画像',
			locale_al_1 = 'アルバムダウンロード',
			locale_al_2 = '閲覧する',
			locale_al_3 = 'Picasa で閲覧',
			locale_al_4 = 'このアルバムをダウンロードできない場合、Picasa でアクセスして下さい。(Picasa インストール必要)',
			locale_al_5 = 'リンクをコビー',
			locale_al_6 = '新しいタブで開け',
			locale_al_7 = 'プライベートアルバムの為、アルバムをアクセスできない。右上辺りの「Picasa で閲覧」ボタンを押して、アルバムをダウンロードして下さい。',
			locale_yt_1 = '削除',
			locale_allpic_1 = '当ページの画像を全てダウンロード',
			locale_piclink_1 = '画像をダウンロード：',
			locale_maxPic_1 = 'ズーム',
			locale_update_1 = 'アップデート',
			locale_update_2 = '新しいバージョン：',
			locale_update_3 = '現行バージョン：：',
			locale_update_4 = 'キャンセル',
			locale_update_5 = 'アップデートチェック',
			locale_update_6 = 'もう更新済！',
			locale_set_title = 'Hover Zoom 設定',
			locale_set_save = '設定保存とページ再読込',
			locale_set_reset = 'リセット',
			locale_set_reset_confirm = '全ての設定をリセットしますが？',
			locale_set_history = 'Hover Zoom 閲覧記録',
			locale_history_title = '閲覧記録',
			locale_his_count_1 = ' 枚写真',
			locale_his_count_2 = ' 枚写真',
			locale_set_clear = 'クリア',
			locale_set_close = '閉じる',
			locale_tab_1 = '一般',
			locale_tab_2 = 'ショートカット',
			locale_tab_3 = 'その他',
			locale_set_1_1 = '遅れ：',
			locale_set_1_2 = 'ミリセカンド (ms)',
			locale_set_2 = '不透明度：',
			locale_set_3_1 = '最大幅：',
			locale_set_3_2 = 'px (0：限制無し)',
			locale_set_4 = 'ダウンロードボタンを有効にする',
			locale_set_5_1 = '閲覧記録を有効にする、最大記録数：',
			locale_set_5_2 = '、段数：',
			locale_set_6 = '(0: 限制無し)',
			locale_set_7_1 = 'トリガー：',
			locale_set_7_2 = '無',
			locale_set_8 = 'コメント欄内の画像リンクを表示、最大幅：',
			locale_set_9 = '画像解像度を表示',
			locale_set_10 = 'フルスクリーンモード：',
			locale_set_11 = 'ダウンロードショートカット：',
			locale_set_12 = '画像を完全ロードしてから表示',
			locale_set_13 = '画像とカーソルを連動しない',
			locale_set_14 = 'ショートカットを表示',
			locale_set_15 = 'アルバムダウンロードを有効にする (公開アルバム限定)',
			locale_set_16_1 = 'コメント欄内の Youtube リンクを表示、長さと幅の比：',
			locale_set_16_2 = '，最大幅：',
			locale_set_17 = '言語：',
			locale_set_18_1 = '有効にする：',
			locale_set_18_2 = 'コンテンツ',
			locale_set_18_3 = 'プロフィールアイコン',
			locale_set_18_4 = 'リンク',
			locale_set_19 = '「当ページの画像を全てダウンロード」を有効にする',
			locale_set_20 = '自動的にアップデートチェック',
			locale_set_21 = '画像の下にダウンロードリンクを表示',
			locale_set_22_1 = 'ストリーム幅で画像表示',
			locale_set_22_2 = '全ての画像に適用する',
			locale_set_22_3 = 'アルバムの一つ目の画像に適用する';
			break;
	}
	...
	var init = {
		normal: function(){
			...
			'<option value="ja-JP">'+locale_lang_04+'</option>'
			);
		...
		fullscreen: function(){
			$content.append(
			'<div id="hoverzoom_info">'+
			'<div class="prev" title="'+locale_fs_10+' (&larr;)"></div>'+
			'<div class="info"><span></span>'+
			'<ul><li id="hoverzoom_fs_01" class="current">'+locale_fs_9+'</li><li id="hoverzoom_fs_02">'+locale_fs_6+'</li><li id="hoverzoom_fs_03">'+locale_fs_7+'</li><li><a href="" target="_blank">'+locale_fs_3+'</a></li><li title="'+locale_fs_1+'" id="hoverzoom_fs_exit">'+locale_fs_2+'</li>'+
			'</ul></div>'+
			'<div class="next" title="'+locale_fs_11+' (&rarr;)"></div></div>'+
			'<img id="hoverzoom_fs" />'
			);
		},
		shortcut: function(){
		...
		history: function(){
			...
			$('#content').append('<div id="hz_history_page" class="hz_settings"><h3>'+locale_history_title+'</h3><small></small><div class="hz_set_function"><div id="hz_his_clear" class="whiteButton button_style" title="'+locale_set_clear+'">'+locale_set_clear+'</div><div id="hz_history_list" class="button_style blueButton" title="'+locale_al_5+'">'+locale_al_5+'</div><div id="hz_his_newtab" class="greenButton button_style" title="'+locale_al_6+'">'+locale_al_6+'</div></div><div id="hz_his_close" class="closeButton" title="'+locale_set_close+'"></div><div id="hz_history_out"><div id="hz_history"></div></div></div>');
			
			var histories = localStorage['hz_histories'].split('|||') || '',
				his = histories.length - 1 || 0;
		...
		album: function(){
			$content.append('<div id="hz_albums_page" class="hz_settings"><h3>'+locale_al_1+'</h3><small></small><div class="hz_set_function"><div id="hz_albums_list" class="button_style blueButton" title="'+locale_al_5+'">'+locale_al_5+'</div><div id="hz_albums_newtab" class="button_style greenButton" title="'+locale_al_6+'">'+locale_al_6+'</div><a id="hz_albums_picasa" class="button_style orangeButton" title="'+locale_al_4+'">'+locale_al_3+'</a></div><div title="'+locale_set_close+'" class="closeButton" id="hz_albums_close"></div><div id="hz_albums_out"><div id="hz_albums"></div></div></div>');
			
			albumDL();
		},
		allPic: function(){
			$('#gbd5 ol.gbmcc').append('<li class="gbkp gbmtc"><a id="hz_allpic_dl" class="gbmt" href="javascript:void(0)">'+locale_allpic_1+'</a></li>');
			$content.append('<div id="hz_allpic_page" class="hz_settings"><h3>'+locale_allpic_1+'</h3><small></small><div class="hz_set_function"><div id="hz_allpic_list" class="button_style blueButton" title="'+locale_al_5+'">'+locale_al_5+'</div><div id="hz_allpic_newtab" class="button_style greenButton" title="'+locale_al_6+'">'+locale_al_6+'</div></div><div title="'+locale_set_close+'" class="closeButton" id="hz_allpic_close"></div><div id="hz_allpic_out"><div id="hz_allpic"></div></div></div>');
	...
	function main(url){
		...
		function fullscreen(){
			...
			$('#hoverzoom_info .info span').text(locale_fs_4);
			$('#hoverzoom_info .info ul li:eq(3) a').attr('href', img.src);
			$fs.show();
			
			if (picCount > 1) {
				$('#hoverzoom_info .info').prepend('<small></small>');
				$('#hoverzoom_info .prev, #hoverzoom_info .next').show();
				$('#hoverzoom_info').removeClass('normal');
				continous();
			} else {
				$('#hoverzoom_info .info small').remove();
				$('#hoverzoom_info .prev, #hoverzoom_info .next').hide();
				$('#hoverzoom_info').addClass('normal');
			}
			...
			function screenSize(){
				...
				timer = setTimeout(function(){
					...
					detect();
					$('#hoverzoom_info .info span').text(nWidth+' x '+nHeight + ' ('+parseInt($fs.width()/nWidth*100)+'%)');
				}, 0);
			...
			function actualSize(){
				...
				$('#hoverzoom_info .info span').text(nWidth+' x '+nHeight + ' (100%)');
			...
			function detect(){
				...
				if ( wWidth > nWidth && wHeight > nHeight ) {
					$('#hoverzoom_fs_01, #hoverzoom_fs_02, #hoverzoom_fs_03').hide();
					$('#hoverzoom_info').addClass('status02');
				} else {
					$('#hoverzoom_fs_01, #hoverzoom_fs_02, #hoverzoom_fs_03').show();
					$('#hoverzoom_info').removeClass('status02');
				}
				
				if ( $('#hoverzoom_fs_02').text().replace(/\D/g,'') == $('#hoverzoom_fs_03').text().replace(/\D/g, '') ) {
					$('#hoverzoom_fs_02').hide();
					$('#hoverzoom_info').addClass('status01');
				} else {
					$('#hoverzoom_fs_02').show();
					$('#hoverzoom_info').removeClass('status01');
				}
			}
			...
			function continous(){
				...
				//if (!$('#hoverzoom_info .info small'))
					$('#hoverzoom_info .info small').html('<strong>'+parseInt(now+1)+'</strong> / '+picCount);
				...
				$('#hoverzoom_info .next').click(next);
				$('#hoverzoom_info .prev').click(prev);
				...
				function next(){
					...
					now = next;
					xScroll = $(document).scrollTop();
					$('#hoverzoom_info .info small').html('<strong>'+parseInt(next+1)+'</strong> / '+picCount);
					
					var nextImg = new Image();
					nextImg.src = nextUrl;
					
					$('#hoverzoom_info .info span').text(locale_fs_4);
					$('#hoverzoom_info .info ul li:eq(3) a').attr('href', nextImg.src);
				...
				function prev(){
					...
					now = prev;
					xScroll = $(document).scrollTop();
					$('#hoverzoom_info .info small').html('<strong>'+parseInt(prev+1)+'</strong> / '+picCount);
					
					var prevImg = new Image();
					prevImg.src = prevUrl;
					
					$('#hoverzoom_info .info span').text(locale_fs_4);
					$('#hoverzoom_info .info ul li:eq(3) a').attr('href', prevImg.src);
	...
	function allPic(){
		...
		$('#hz_allpic_newtab').click(function(){
			newTab($('#hz_allpic'));
		});
	...
	function albumDL(){
		...
		$('#hz_albums_newtab').click(function(){
			newTab($('#hz_albums'));
		});
			...
			if (options['hz_maxpic'] === 'true'){
				$('div[data-content-type^="image"] img').each(function(){
					...
					if (!$(this).parent().hasClass('maxPic')){
						...
						$(this).parent().css({'maxHeight': 'none', 'maxWidth': 'none', 'width': 'auto', 'paddingBottom': '5px'});
						$(this).css('width', '100%');
