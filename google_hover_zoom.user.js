...
var timer = new function(){
	...
	var album = function(){
		...
		if (page.match(/\/photos\/\w+\/albums\/\w+/)){
			var $nav = $('nav');
			if (!$nav.data('class')){
				var button = $('<div class="hz_in-albumDownload hz_button blue">'+lang.fs03+'</div>').data('url', page);
