...
// Enable functions
var enable = function(){
	if (options.hz_enable_main === 'true') $content.on('mouseenter', 'img.yqrXXd', hoverzoom);
...
var disable = function(){
	if (options.hz_enable_main === 'true') $content.off('mouseenter', 'img.yqrXXd', hoverzoom);
