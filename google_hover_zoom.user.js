		...
		body: {
			...
			set: {
				...
				html: '<div class="back"></div><div class="main"><h3>'+lang.set01+'</h3><small>Ver. '+version+' by <a href="https://plus.google.com/105931860008509594725" target="_blank">SkyArrow</a></small><div class="close" title="'+lang.set10+'"></div>'+
					...
					'<input id="hz_direct_post" type="checkbox"><label for="hz_direct_post">'+lang.set48+'</label><input id="hz_direct_post_max" type="text" maxlength="4"><label for="hz_direct_post_max">'+lang.set18+'</label><br>'+
...
if (options.hz_shortcut === 'true') appendElement.body(elements.body.sc);
...
$('#gbmpdv').append('<div id="hz_opts"><strong>Google+ Hover Zoom</strong><a id="disable_hz">'+lang.menu02+'</a><ul></ul></div>');
$('#hz_opts ul').append(fragment.menu);
...
var albumDL = function(){
	...
	var meta = function(length, author, album){
		var text;
		if (length > 1) {
			text = '<a href="'+author[1]+'" target="_blank">'+author[0]+'</a> &raquo; <a href="'+album[1]+'" target="_blank"><strong>'+album[0]+'</strong></a> ('+length+' '+lang.set08+')';
		} else {
			text = '<a href="'+author[1]+'" target="_blank">'+author[0]+'</a> &raquo; <a href="'+album[1]+'" target="_blank"><strong>'+album[0]+'</strong></a> ('+length+' '+lang.set07+')';
		}
		$page.find('small').html(text);
	}
